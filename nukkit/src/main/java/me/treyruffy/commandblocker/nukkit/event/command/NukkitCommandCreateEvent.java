 ...
 */
public class NukkitCommandCreateEvent extends NukkitCommandEvent implements Cancellable {
   ...
   */
  public NukkitCommandCreateEvent(final CommandCreateEvent apiEvent) {
    super(apiEvent);
  }
