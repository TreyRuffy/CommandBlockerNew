 ...
 */
package me.treyruffy.commandblocker.nukkit.logger;
...
public class Log implements Logger {
  ...
  public void info(final @NotNull String message) {
    CommandBlockerNukkit.get().getLogger().info(message);
  }

  @Override
  public void warn(final @NotNull String message) {
    CommandBlockerNukkit.get().getLogger().warning(message);
  }
  ...
  public void warn(final @NotNull String message, final @Nullable Throwable throwable) {
    ...
    CommandBlockerNukkit.get().getLogger().warning(message, throwable);
  }

  @Override
  public void severe(final @NotNull String message) {
    CommandBlockerNukkit.get().getLogger().critical(message);
  }
  ...
  public void severe(final @NotNull String message, final @Nullable Throwable throwable) {
    ...
    CommandBlockerNukkit.get().getLogger().critical(message, throwable);
  }
}
