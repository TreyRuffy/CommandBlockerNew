 ...
 */
package me.treyruffy.commandblocker.nukkit.event.command;
 ...
 */
public class NukkitCommandRemoveEvent extends NukkitCommandEvent implements Cancellable {
   ...
   */
  public NukkitCommandRemoveEvent(final CommandRemoveEvent apiEvent) {
    super(apiEvent);
  }
