 ...
 */
public class SpongeCommandRemoveEvent extends SpongeCommandEvent implements Cancellable {
   ...
   */
  public SpongeCommandRemoveEvent(final CommandRemoveEvent apiEvent) {
    super(apiEvent);
  }
