 ...
 */
public class SpongeCommandCreateEvent extends SpongeCommandEvent implements Cancellable {
   ...
   */
  public SpongeCommandCreateEvent(final CommandCreateEvent apiEvent) {
    super(apiEvent);
  }
