 ...
 */
package me.treyruffy.commandblocker.spongelegacy.event.player;
 ...
 */
public class SpongeLegacyBlockedCommandEvent extends SpongeLegacyCommandBlockerEvent implements Cancellable {
   ...
   */
  public SpongeLegacyBlockedCommandEvent(final BlockedCommandEvent apiEvent) {
    super(apiEvent);
  }
  ...
  public @NotNull Cause getCause() {
    return Cause.of(EventContext.empty(), this.player(), CommandBlockerSpongeLegacy.get());
  }
}
