 ...
 */
package me.treyruffy.commandblocker.spongelegacy.logger;
...
public class Log implements Logger {
  ...
  public void info(final @NotNull String message) {
    CommandBlockerSpongeLegacy.get().logger().info(message);
  }

  @Override
  public void warn(final @NotNull String message) {
    CommandBlockerSpongeLegacy.get().logger().warn(message);
  }
  ...
  public void warn(final @NotNull String message, final @Nullable Throwable throwable) {
    ...
    CommandBlockerSpongeLegacy.get().logger().warn(message, throwable);
  }

  @Override
  public void severe(final @NotNull String message) {
    CommandBlockerSpongeLegacy.get().logger().error(message);
  }
  ...
  public void severe(final @NotNull String message, final @Nullable Throwable throwable) {
    ...
    CommandBlockerSpongeLegacy.get().logger().error(message, throwable);
  }
}
