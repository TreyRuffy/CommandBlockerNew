 ...
 */
package me.treyruffy.commandblocker.bukkitlegacy.event.player;
 ...
 */
public class BukkitBlockedCommandEvent extends BukkitCommandBlockerEvent implements Cancellable {
   ...
   */
  public BukkitBlockedCommandEvent(final BlockedCommandEvent apiEvent) {
    super(apiEvent);
  }
