...
/**
 * The Bukkit Legacy command handler.
 */
public class BukkitLegacyCommandHandler extends CommandHandler<CommandSender> implements CommandExecutor {
   ...
   * The Bukkit Legacy command handler.
   */
  public BukkitLegacyCommandHandler() {
  ...
  public void sendMessage(final @NotNull CommandSender sender, final @NotNull Component component) {
    CommandBlockerBukkitLegacy.adventure().sender(sender).sendMessage(component);
  }
