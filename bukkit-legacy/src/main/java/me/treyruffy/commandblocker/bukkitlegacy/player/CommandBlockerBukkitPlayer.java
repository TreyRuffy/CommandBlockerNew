 ...
 */
package me.treyruffy.commandblocker.bukkitlegacy.player;
...
public class CommandBlockerBukkitPlayer implements CommandBlockerPlayers<Player> {
  ...
  public void sendMessage(final @NotNull Component message) {
    me.treyruffy.commandblocker.bukkitlegacy.CommandBlockerBukkitLegacy.adventure().player(this.player).sendMessage(message);
  }
  ...
  public void sendActionBar(final @NotNull Component message) {
    CommandBlockerBukkitLegacy.adventure().player(this.player).sendActionBar(message);
  }

  @Override
  public void showTitle(final @NotNull Title title) {
    CommandBlockerBukkitLegacy.adventure().player(this.player).showTitle(title);
  }
