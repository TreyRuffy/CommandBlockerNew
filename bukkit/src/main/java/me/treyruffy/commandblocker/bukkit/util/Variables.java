...
public class Variables implements ComponentTranslator {
  ...
  @NotNull TagResolver playerTags(final @NotNull Player player) {
    return TagResolver.resolver(
      ...
      TagResolver.resolver("player_locale", Tag.selfClosingInserting(Component.text(player.getLocale()))),
  ...
  @NotNull TagResolver serverTags() {
    return TagResolver.resolver(
      TagResolver.resolver("server_name", Tag.selfClosingInserting(Component.text(CommandBlockerBukkit.get().getServer().getName()))),
      TagResolver.resolver("server_ip", Tag.selfClosingInserting(Component.text(CommandBlockerBukkit.get().getServer().getIp()))),
      TagResolver.resolver("server_port", Tag.selfClosingInserting(Component.text(CommandBlockerBukkit.get().getServer().getPort()))),
      TagResolver.resolver("server_motd", Tag.selfClosingInserting(Component.text(CommandBlockerBukkit.get().getServer().getMotd()))),
      TagResolver.resolver("server_max_players", Tag.selfClosingInserting(Component.text(CommandBlockerBukkit.get().getServer().getMaxPlayers()))),
      TagResolver.resolver("server_online_players", Tag.selfClosingInserting(Component.text(CommandBlockerBukkit.get().getServer().getOnlinePlayers().size()))),
      TagResolver.resolver("server_version", Tag.selfClosingInserting(Component.text(CommandBlockerBukkit.get().getServer().getVersion()))),
      TagResolver.resolver("server_bukkit_version", Tag.selfClosingInserting(Component.text(CommandBlockerBukkit.get().getServer().getBukkitVersion())))
    );
  }
