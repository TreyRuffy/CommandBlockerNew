 ...
 */
public class BukkitCommandCreateEvent extends BukkitCommandEvent implements Cancellable {
   ...
   */
  public BukkitCommandCreateEvent(final CommandCreateEvent apiEvent) {
    super(apiEvent);
  }
