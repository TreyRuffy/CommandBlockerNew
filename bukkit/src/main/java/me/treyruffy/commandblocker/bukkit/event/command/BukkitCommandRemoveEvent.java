 ...
 */
package me.treyruffy.commandblocker.bukkit.event.command;
 ...
 */
public class BukkitCommandRemoveEvent extends BukkitCommandEvent implements Cancellable {
   ...
   */
  public BukkitCommandRemoveEvent(final CommandRemoveEvent apiEvent) {
    super(apiEvent);
  }
