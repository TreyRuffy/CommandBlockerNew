...
/**
 * Called when a {@link AbstractCommand} event is called.
 *
 * @since 3.0.0
 */
public class CommandEvent extends CommandBlockerEvent {
   ...
   */
  public CommandEvent(final AbstractCommand command) {
