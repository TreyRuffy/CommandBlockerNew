 ...
 * @since 3.0.0
 */
public class CommandCreateEvent extends CommandEvent implements Cancellable {

  private boolean cancelled = false;

  /**
   * Creates a create command event.
   *
   * @param command the command
   */
  public CommandCreateEvent(final AbstractCommand command) {
    super(command);
  }
