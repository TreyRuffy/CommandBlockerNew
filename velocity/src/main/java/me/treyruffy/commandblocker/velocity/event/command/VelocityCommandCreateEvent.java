 ...
 */
public class VelocityCommandCreateEvent extends VelocityCommandEvent implements ResultedEvent<ResultedEvent.GenericResult> {
   ...
   */
  public VelocityCommandCreateEvent(final CommandCreateEvent apiEvent) {
    super(apiEvent);
  }
