 ...
 */
package me.treyruffy.commandblocker.velocity.logger;
...
public class Log implements Logger {
  ...
  public void info(final @NotNull String message) {
    CommandBlockerVelocity.get().logger().info(message);
  }

  @Override
  public void warn(final @NotNull String message) {
    CommandBlockerVelocity.get().logger().warn(message);
  }
  ...
  public void warn(final @NotNull String message, final @Nullable Throwable throwable) {
    ...
    CommandBlockerVelocity.get().logger().warn(message, throwable);
  }

  @Override
  public void severe(final @NotNull String message) {
    CommandBlockerVelocity.get().logger().error(message);
  }
  ...
  public void severe(final @NotNull String message, final @Nullable Throwable throwable) {
    ...
    CommandBlockerVelocity.get().logger().error(message, throwable);
  }
}
