 ...
 */
package me.treyruffy.commandblocker.bungee.event.command;
 ...
 */
public class BungeeCommandCreateEvent extends BungeeCommandEvent implements Cancellable {
   ...
   */
  public BungeeCommandCreateEvent(final CommandCreateEvent apiEvent) {
    super(apiEvent);
  }
