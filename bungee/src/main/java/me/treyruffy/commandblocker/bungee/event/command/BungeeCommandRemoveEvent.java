 ...
 */
public class BungeeCommandRemoveEvent extends BungeeCommandEvent implements Cancellable {
   ...
   */
  public BungeeCommandRemoveEvent(final CommandRemoveEvent apiEvent) {
    super(apiEvent);
  }
